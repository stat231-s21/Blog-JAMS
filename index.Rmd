...
In addition to the removal of so-called stop words from the dataset, we also omitted the words "access" and "water" because it is obvious that all the tweets should include those words from the way we collected data. Doing so helps us produce more meaningful word clouds and sentiment analyses.
