...
- For the text analysis of tweets, Masahiro created a unique dataset using the search_tweets() function through his Twitter development account. The tweets addressed in the dataset are those generated in the period starting from April 27th and ending on May 7th this year. The tweets are selected if they include one of the following phrases: "water access," or "Water access," or "Water Access," or "access to clean water," or "access to drinking water.”
...
# Prof Correia's resources (to be deleted) {.tabset .tabset-fade .tabset-pills}
